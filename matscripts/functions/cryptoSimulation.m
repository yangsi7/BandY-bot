...
elseif A.params == 2
   ...
   A.ftp=0.47;
   A.slfix = 0;
   A.slscale1 = 3.051885707049924;
   A.slscale2 = 2.607938690629648;
   A.slscale3 = 0.001000000000000;
   A.slscale4 = 0.919260816863469;
   A.slmax = 0.054113056424365;
   A.prelstop = 0.034681542931803;
   A.presstop = 0.038809843031689;
   A.adxth=5.0000;
   A.rsiobos=74.30;
elseif A.params == 3
   A.tp1=1;
