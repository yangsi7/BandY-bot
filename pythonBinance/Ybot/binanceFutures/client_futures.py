...
class Client(object):
    ...
    def set_initial_leverage(self, **params):
        ...
        timestamp	LONG	YES
        """
        return self._post('leverage', True, data=params)

    def modify_position(self, **params):
        """
        symbol	STRING	YES
        amount	DECIMAL	YES
        type	INT	YES	1: Add postion margin，2: Reduce postion margin
        recvWindow	LONG	NO
        timestamp	LONG	YES
"""
        return self._post('positionMargin', True, data=params)
